...
4. Choose visual treatments, then create up to 12 drafts. Start rendering on the review screen. Keep it open; a completed draft is saved after each video. Interrupted batches can resume. Failed requests become retryable after their ten-minute lease expires.
...
- Four 1080×1920 treatments: moving lyric typography, audio-reactive waveform, artwork camera motion, and performance footage with lyrics. Performance footage must align with the source audio from time zero. No generative-video subscription is required.
