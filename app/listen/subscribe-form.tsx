...
// Fan email capture on the public /listen pages → Brevo list.
export default function SubscribeForm() {
  ...
  if (state === "done") {
    return (
      <p className="rc-sub" style={{ marginTop: 22, fontSize: 13.5 }}>
  ...
  return (
    <form onSubmit={submit} style={{ marginTop: 22 }}>
      <p className="rc-sub" style={{ fontSize: 12.5, marginBottom: 8 }}>Get new music first</p>
