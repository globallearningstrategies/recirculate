...
import CinematicPanel from "./cinematic-panel";
...
export default function Studio({ reloadHref = "/studio?reload=1" }: { reloadHref?: string }) {
  ...
  return <main className="studio-shell">
    ...
    <CinematicPanel jobs={jobs} onDraft={async (batchId) => { await refreshJobs(); setBatch(batchId); setStep("review"); setMessage("Cinematic footage is ready. Tap Render / resume batch to add your song and captions."); window.scrollTo({ top: 0, behavior: "smooth" }); }} />
